                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-3" style="max-width: 80rem;">
                            ...
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <button class="btn btn-success btn-sm"><span class="fa fa-search"></button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                ...
                                <hr>
                                <div class="card-header">
                                    <h5><b>Informacion de producto:</b></h5>
                                </div>
                                <section class="row">
                                    <section class="col-md-1"></section>
                                    <section class="col-md-10">
                                        ...
                                        <section class="row">
                                            ...
                                            <section class="col-md-2" style="text-align: center;">
                                                <button class="btn btn-success" style="max-width:100%"><span class="fa fa-save"></span> Guardar</button>
                                            </section>
