                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-3" style="max-width: 80rem;">
                            <div class="card-header">
                              <h5><b>Registro de productos</b></h5>
                            </div>
                            <div class="card-body">
                                <h6>
                                </h6>
                                    ...
                                    <section class="col-md-10">
                                        <section class="row">
                                            ...
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-barcode"></a></span>
                                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Primer nombre" disabled>
                                                </div>
                                            </section>
                                            <section class="col-md-4">
                                                <label for="exampleInputEmail1" class="form-label">Categoria de producto:</label>
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-users"></a></span>
                                                    <select class="form-select" name="estimacion_probabilidad" id="estimacion_probabilidad" required>
                                                        <option value="0" selected>Selecciona...</option>
                                                        <option value="1">Abarrotes</option>
                                                        <option value="2">Aseo</option>
                                                        <option value="3">Lacteos</option>
                                                        <option value="4">Confiteria/Dulces</option>
                                                        <option value="5">Harinas/Pan</option>
                                                        <option value="6">Bebidas</option>
                                                        <option value="7">Enlatados</option>
                                                        <option value="7">Lacteos</option>
                                                        <option value="8">Higiene/Aseo Personal</option>
                                                    </select>
                                                </div>
                                            </section>

                                            <section class="col-md-4">
                                                <label for="exampleInputEmail1" class="form-label">Presentacion Producto:</label>
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-bottle-water"></a></span>
                                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Ej:Bolsa,Botella,Paquete,etc">
                                                </div>
                                            </section>
                                        ...
                                        <section class="row">
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-tag"></a></span>
                                                    <select class="form-select" name="estimacion_probabilidad" id="estimacion_probabilidad" required>
                                                        <option value="0" selected>Selecciona...</option>
                                                        <option value="1">Gramos(Gr)</option>
                                                        <option value="2">Libras(Lb)</option>
                                                        <option value="3">Kilogramos(Kg)</option>
                                                        <option value="4">Mililitros(Ml)</option>
                                                        <option value="5">Litros(Lt)</option>
                                                    </select>
                                                </div>
                                            </section>
                                            
                                            <section class="col-md-4">
                                                <label for="exampleInputEmail1" class="form-label">Peso(numero):</label>
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-weight-hanging"></a></span>
                                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                            </section>

                                            <section class="col-md-4">
                                                <label for="exampleInputEmail1" class="form-label">Stock(Unidades Existentes):</label>
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-boxes-stacked"></a></span>
                                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                            </section>
                                        ...
                                        <section class="row">
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-money-bill"></a></span>
                                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                            </section>
                                            ...
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    ...
                                                    <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                            </section>

                                            <section class="col-md-4">
                                                <label for="exampleInputEmail1" class="form-label">Fecha Recibo:</label>
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-calendar"></a></span>
                                                    <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                        ...
                                        <section class="row">
                                            ...
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-cube"></a></span>
                                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                            </section>
                                            ...
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-file"></a></span>
                                            ...
                                            <section class="col-md-4">
                                                ...
                                                <div class="input-group mb-3"> 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-image"></a></span>
                                                    <input type="file" class="form-control" id="exampleInputEmail1" placeholder="Primer Apellido">
                                                </div>
                                            </section>
                                        ...
                                        <section class="row">
                                            ...
                                            <section class="col-md-8">
                                                ...
                                                <div class="input-group mb-3" > 
                                                    <span class="input-group-text" id="basic-addon1"><a class="fas fa-pencil"></a></span>
                                                    <textarea name="" id="" cols="80" rows="4" placeholder="Descripcion breve del producto"></textarea>
                                                </div>
                                            </section>
                                        ...
                                        <section class="row">
                                            ...
                                            <section class="col-md-2" style="text-align: center;">
                                                <button class="btn btn-success" style="max-width:100%"><span class="fa fa-save"></span> Registrar</button>
                                            </section>
        
                                            <section class="col-md-2" style="text-align: center;">
                                                <button class="btn btn-danger" style="max-width:100%"><span class="fa fa-times"></span> Cancelar</button>
                                            </section>
