            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <hr>
                        <h1 class="mt-4">Registro de pedidos</h1>
                        <hr>
                        ...
                        <div class="container-fluid mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        ...
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Proveedores</h3>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log8.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Listado General</h3>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log7.jpg" alt="">
                                        <div class="offer-text">
                                ...
                                <div class="container-fluid px-4">
                                    ...
                                    <div class="card mb-3" style="max-width: 80rem;">
                                        <div class="card-header">
                                          <h5><b>Listado general de pedidos:</b></h5>
                                        </div>
                                        <div class="card-body">
                                            <section class="row">
