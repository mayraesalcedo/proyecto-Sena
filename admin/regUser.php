        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <hr>
                        <h1 class="mt-4">Registrar/Agregar Usuario</h1>
                        <hr>
                        ...
                        <div class="card mb-3" style="max-width: 80rem;">
                            ...
                            <div class="card-body">
                                <h6>Todos los datos e informacion diligenciados en el siguiente formulario seran 
                                    utilizados con fines laborales para alimentar la base de datos y seran sometidos a un proceso de validacion y verificacion, 
                                    por favor diligencie informacion real y veridica.
                                </h6>
                                <hr>
                                <section class="row">
                                ...
                                <section class="row">
                                    ...
                                    <section class="col-md-4" style="text-align: center;">
                                        <button onclick="registrarUsuario()" name="boton_registro" id="boton_registro" class="btn btn-success"><span class="fa fa-save"></span> Registrar</button>
                                    </section>
            ...
            <script type="text/javascript">
                ...
                function registrarUsuario(){
                    ...
                    if (nombres == "" || apellidos == "" || tipo_documento == "" || tipo_documento == 0 || numero_documento == "" || correo == "" || tel_contacto == "" || direccion == "" || fecha_nacimiento == "") {
                        Swal.fire(
                ...
                async function registrarUsuario2(){
                    let formulario = new FormData();
                    ...
                    let contrasena = generarContraseña(10);
