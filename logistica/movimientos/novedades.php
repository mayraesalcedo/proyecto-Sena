            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <hr>
                        <h1 class="mt-4">Registro de novedades</h1>
                        <hr>
                        ...
                        <div class="container-fluid mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        ...
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Devoluciones</h3>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log5.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Incidencias</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log6.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Cronograma de inventarios</h3>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        ...
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Reportes</h3>
