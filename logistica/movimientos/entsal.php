            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <hr>
                        <h1 class="mt-4">Panel administracion entrada y salidas</h1>
                        <hr>
                        ...
                        <div class="container-fluid mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log1.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Entradas</h3>
                                            <a href="" class="btn btn-info">Cargar</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log2.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Salidas</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log3.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Novedades</h3>
                                            <a href="" class="btn btn-warning">Cargar</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-offer mb-30" style="height: 200px;">
                                        <img class="img-fluid" src="../../img/log4.jpg" alt="">
                                        <div class="offer-text">
                                            <h3 class="text-white mb-3">Registro Historico</h3>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button class="btn btn-warning btn-sm"><span class="fa fa-edit"></button></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>2</td>
